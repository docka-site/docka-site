const ACCENT = "#D4E84A";
const ACCENT_DARK = "#B8CC2E";
const ACCENT_TEXT = "#1a2200";

export function AmareloLimao() {
  return (
    <div style={{ fontFamily: "'Montserrat', sans-serif", background: "#05142a", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, padding: "52px 32px 32px" }}>
        ...
        <div style={{ marginTop: 22 }}>
          <span style={{ background: ACCENT, color: ACCENT_TEXT, fontWeight: 700, fontSize: "0.6rem", letterSpacing: "0.1em", textTransform: "uppercase", padding: "10px 22px", borderRadius: 50, display: "inline-flex", alignItems: "center", gap: 6 }}>
        ...
        <div style={{ marginTop: 32, padding: "10px 14px", background: "rgba(255,255,255,0.05)", borderRadius: 6, display: "inline-block" }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.65rem", marginLeft: 8 }}>Amarelo Limão</span>
        </div>
      </div>
    </div>
  );
